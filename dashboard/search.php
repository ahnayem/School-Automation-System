	...
	<body class="cbp-spmenu-push">
		...
		<div id="page-wrapper" style="height: -webkit-fill-available">
			...
			<div class="main-page general">
				...
				<div class="forms">
					<h2 class="title1">Select Search Option</h2>
							...
							<div class="row" >
								<div class="grid_box1" style="margin-bottom: 0em">
									<div class="col-md-12 grid_box1" style="padding: 10px">
										<a class="btn btn-primary btn-block" href="search_student.php" style="color:white;">Student Info Search</a>
									</div>
									<div class="col-md-12 grid_box1" style="padding: 10px">
										<a class="btn btn-primary btn-block" href="search_teacher.php" style="color:white; ">Teacher Info Search</a>
									</div>
									<div class="col-md-12 grid_box1" style="padding: 10px">
										<a class="btn btn-primary btn-block" href="search_stuff.php" style="color:white; ">Staff Info Search</a>
									</div>
								</div>
