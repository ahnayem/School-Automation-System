        ...
        */
        if (!empty($name) && !empty($email) && !empty($password)) {
            ...
            if (empty($error)) {
                ...
                $to = $email;
                $subject = "VU PROJECT | Email Confirmation";
                $txt = "<a href='localhost/pro/vu-project/email_confirmation.php?id=$token' style='height:80px;width:250px;background:red;color:white; padding: 30px;text-decoration:none;'>Confirm Email</a>";
                $headers = "Content-Type: text/html; charset=ISO-8859-1\r\n".
                "From: rkreza24@gmail.com" . "\r\n" .
                "CC: rkreza42@example.com";
                ...
                if (empty($error) && $mail) {
                    ...
                    $query    = "INSERT INTO users(user_name, user_email, user_password, user_token) 
