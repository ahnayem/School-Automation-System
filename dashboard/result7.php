	...
	<body class="cbp-spmenu-push">
		...
		<div id="page-wrapper" style="height: -webkit-fill-available">
			...
			<div class="main-page general">
				<h2 class="title1">Result Process Class 7 </h2>
					...
					<div class="panel-grids">
						<div class="bs-example widget-shadow" data-example-id="bordered-table" style="margin-top: 0px; "> 
                            ...
                            <table class="table table-bordered"> 
                                <thead> 
                                    <tr> 
                                        <th style="color: green">Class 7</th> 
                                ...
                                <tbody> 
                                    <?php 
                                        ...
                                        $query1 ="SELECT * from result_process_status7";
...
<td><?php if($row1['sub4']==1){echo '<p style="color:#9933ff">'."finished".'</p>';}
                            ...
                            <button class="btn btn-default hvr-icon-spin col-5" type="submit" name="generate" <?php if($check==0) {echo "disabled";} ?> >Generate Result</button>
                                <?php } ?>
					</div>
