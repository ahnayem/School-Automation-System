	...
	<body class="cbp-spmenu-push">
		...
		<div id="page-wrapper" style="height: -webkit-fill-available">
			...
			<div class="main-page general">
				<h2 class="title1">Result Process Class 6 </h2>
                            ...
                            <table class="table table-bordered"> 
                                ...
                                <tbody> 
                                    <?php 
                                        ...
                                        $query1 ="SELECT * from result_process_status6";
...
<td><?php if($row1['sub4']==1){echo '<p style="color:#9933ff">'."finished".'</p>';}
                            ...
                            <button class="btn btn-default hvr-icon-spin col-5" type="submit" id="submit" name="submit" value="result_class_6" <?php if($check==0) {echo "disabled";} else{ $_SESSION['cls'] = 'result_class_6';} ?> >Generate Result</button>
       						 <?php } ?>
                                </form>
