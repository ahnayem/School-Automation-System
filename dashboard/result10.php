	...
	<body class="cbp-spmenu-push">
		...
		<div id="page-wrapper" style="height: -webkit-fill-available">
			...
			<div class="main-page general">
				<h2 class="title1">Result Process Class 10 </h2>
					...
					<div class="panel-grids">
						<div class="bs-example widget-shadow" data-example-id="bordered-table" style="margin-top: 0px; "> 
                            ...
                            <table class="table table-bordered"> 
                                <thead> 
                                    <tr> 
                                        <th style="color: green">Class 10</th> 
...
<td><?php if($row1['sub4_practical']==1){echo '<p style="color:#9933ff">'."finished".'</p>';}
                            ...
                            <button class="btn btn-default hvr-icon-spin col-5" type="submit" name="generate" value="result_class_10" <?php if($check==0) {echo "disabled";} ?> >Generate Result</button>
                                <?php } ?>
					</div>
