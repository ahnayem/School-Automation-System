	...
	<body class="cbp-spmenu-push">
		...
		<div id="page-wrapper" style="height: -webkit-fill-available">
			...
			<div class="main-page general">
				...
				<div class="forms">
					<div><h2 class="title1">Search Teacher</h2><br></div>
...
<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
		...
		if($id == '' || empty($id)){
			...
			echo 'alert("please give Teacher ID")';
			echo '</script>';
		}
  							...
  							<?php if($check == 1): ?>
				  				...
				  				<div class="panel panel-info">
							  		...
							  		<div class="panel-body">
							  			...
							  			<?php if($row==0) {echo 'Teacher not found!';}?>
							  			
							  			<?php if($row>0):?>
							  			
							  				<p>ID: <?php echo $row['teacher_id']; ?></p>
							  				<p>Name: <?php echo $row['teacher_name']; ?></p>
							  				<p>Designation: <?php echo $row['teacher_designation']; ?></p>
							  				<p>Mobile: <?php echo $row['mobile']; ?></p>
							  				<p>Email: <?php echo $row['teacher_email']; ?></p>
							  				<p>Blood group: <?php echo $row['blood_group']; ?></p>
							  				<p>Join: <?php echo date("d M, Y", strtotime($row['teacher_registration_date'])); ?></p>
							  			<?php endif ?>
							  		</div>
								</div>
